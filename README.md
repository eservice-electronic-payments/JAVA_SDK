...
* __GetMobileCashierURLCall__ get the cashier url which will show the cashier UI to input cardInfo (such as card number,expiryMonth, expiryYear, name on card ) and other related pages.
